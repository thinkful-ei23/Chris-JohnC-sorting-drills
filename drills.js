...
function bucketSort(arr,lowest,highest){
  ...
  for(let i = lowest;i <=highest; i++){
    if(arr.indexOf(i)>0){
      tempArray.push(arr[arr.indexOf(i)])
    }
  };
  return tempArray
};

//using lowest and highest
//temp storage is allowed ///an array dur
//thinking in cards sorting by rank
//knowing they are integers is a big hint ///able to use > or <
//two for loops


const data2 = [6,4,2,1,8,9,7,10,6,5,3,89]

console.log(bucketSort(data2,1,89))
